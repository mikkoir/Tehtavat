...
function nayta1(){
  document.getElementsByTagName('img')[3].innerHTML= '<img src="'+pics[0].big+'">';
}
function nayta2(){
  document.getElementsByTagName('img')[3].innerHTML= '<img src="'+pics[1].big+'">';
}
function nayta3(){
  document.getElementsByTagName('img')[3].innerHTML= '<img src="'+pics[2].big+'">';
}

function piilo() {
  document.getElementsByTagName('img')[3].innerHTML='';
